...
return [
    ...
    'accepted_if' =>
        'Dit veld moet worden geaccepteerd wanneer :other gelijk is aan :value.',
    ...
    'alpha_dash' =>
        'Dit veld mag alleen letters, nummers, underscores (_) en streepjes (-) bevatten.',
    ...
    'gte' => [
        ...
        'file' =>
            'Het bestand moet groter of gelijk zijn aan :value kilobytes.',
    ...
    'lte' => [
        ...
        'file' =>
            'Het bestand moet kleiner of gelijk zijn aan :value kilobytes.',
    ...
    'prohibited_if' =>
        'Dit veld is verboden indien :other gelijk is aan :value.',
    ...
    'required_if' =>
        'Dit veld is verplicht indien :other gelijk is aan :value.',
    'required_unless' =>
        'Dit veld is verplicht tenzij :other gelijk is aan :values.',
    ...
    'required_without_all' =>
        'Dit veld is verplicht als :values niet ingevuld zijn.',
