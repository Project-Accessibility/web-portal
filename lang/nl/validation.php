...
return [
    ...
    'before_or_equal' =>
        ':Attribute moet een datum vóór of gelijk aan :date zijn.',
    'between' => [
    ...
    'lte' => [
        ...
        'file' =>
            ':Attribute moet kleiner of gelijk zijn aan :value kilobytes.',
    ...
    'prohibited_if' =>
        ':Attribute is niet toegestaan indien :other gelijk is aan :value.',
    'prohibited_unless' =>
        ':Attribute is niet toegestaan tenzij :other gelijk is aan :values.',
    ...
    'starts_with' =>
        ':Attribute moet beginnen met een van de volgende: :values.',
