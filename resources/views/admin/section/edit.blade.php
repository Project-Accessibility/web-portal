...
@section('content')
    ...
    <form method="POST" action="{{route('sections.update', [$research->id,$questionnaire->id, $section->id])}}">
        ...
        <div class="col-md-6">
            ...
            <x-input  type="select" label="Teachable machine class" name="teachable_machine_class" :extraData="['multiple'=>false,'options'=>$classNames]"
                      :value="$section->teachable_machine_class"></x-input>
        </div>
        <h2>Geofence</h2>
        <div class="row">
            <div class="col-md-6">
