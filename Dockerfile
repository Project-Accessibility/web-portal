...
RUN sed -i "s|SEED_NAME=|SEED_NAME=${SEED_NAME}|g" .env
RUN sed -i "s|SEED_EMAIL=|SEED_EMAIL=${SEED_EMAIL}|g" .env
RUN sed -i "s|SEED_PASSWORD=|SEED_PASSWORD=${SEED_PASSWORD}|g" .env
